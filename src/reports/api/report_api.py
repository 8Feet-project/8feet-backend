...
def _serialize_citation(citation):
    if isinstance(citation, dict):
        ...
        return {
            ...
            "authority_score": citation.get("authority_score") or "",
            "authority_tier": citation.get("authority_tier") or "",
            "authority_label": citation.get("authority_label") or "",
            "authority_reason": citation.get("authority_reason") or "",

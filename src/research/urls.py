...
urlpatterns = [
    ...
    path('history/<int:task_id>/reload', research_history_reload, name='research-history-reload'),
    path('history/<int:task_id>/reload/', research_history_reload, name='research-history-reload-slash'),
